...
public:
  ...
  typedef void (responseHandler)(RTSPClient* rtspClient,
      ...
      //             - using "delete[]".
  unsigned sendInputCommand(MediaSession& session, responseHandler* responseHandler, Boolean streamUsingTCP, Authenticator* authenticator = NULL);
  ...
  static  Boolean parseTransportParams(char const* paramsStr,
  ...
  int GetClientConnectSocket() const;
...
private:
  ...
  Boolean handleINPUTResponse(MediaSession* session, char const* sessionParamsStr, char const* transportParamsStr, Boolean streamUsingTCP);
