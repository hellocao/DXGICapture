...
public:
  ...
  void continueAfterINPUT(int resultCode, char* resultString);
  void scheduleReset();
...
protected:
  ...
  InputSession* m_clientInputSession;
private:
  friend class ProxyRTSPClient;
  friend class ProxyServerMediaSubsession;
  friend class ProxyRTSPClientSession;
  void continueAfterDESCRIBE(char const* sdpDescription);
  void continueAfterINPUT(char const* transportParamStr);
